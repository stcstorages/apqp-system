...
import PrintSelector from '@/app/components/PrintSelector'
...
export default async function FmeaPage({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Print Selector Dropdown (Standard / Custom) */}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                */}
                <tr className="bg-blue-50 border-t-2 border-blue-100">
                  ...
                  {/* 14-17. Results */}
                  <td className="p-0 border-r w-8 bg-gray-50"><input form={`add-form-${step.id}`} name="act_severity" type="number" placeholder="S" className="w-full h-full border-0 bg-transparent text-center text-xs font-bold text-gray-400 focus:text-black" /></td>
                  <td className="p-0 border-r w-8 bg-gray-50"><input form={`add-form-${step.id}`} name="act_occurrence" type="number" placeholder="O" className="w-full h-full border-0 bg-transparent text-center text-xs font-bold text-gray-400 focus:text-black" /></td>
                  <td className="p-0 border-r w-8 bg-gray-50"><input form={`add-form-${step.id}`} name="act_detection" type="number" placeholder="D" className="w-full h-full border-0 bg-transparent text-center text-xs font-bold text-gray-400 focus:text-black" /></td>
