...
// ... (keep helpers getWeekNumber, getGroupColor, formatDate) ...
// Copy helpers from previous version or ask if needed.
// For brevity, I assume helpers are there.
...
export default async function GanttPrintPage({
  ...
  // ... (Rest of Gantt logic: Calculate Bounds, Generate Weeks, Render) ...
  // Copy the logic from the previous correct version, just ensure the top part (fetching) matches above.
